...
@interface MyTopRatedViewController ()
...
@implementation MyTopRatedViewController
...
- (void)groupByAlbumArtistPreferenceDidChange {
    // [NSFetchedResultsController deleteCacheWithName:@"Top_Rated_Song_Cache"];
...
- (NSFetchedResultsController *)fetchedResultsController {
    if (!fetchedResultsController) {
        ...
        if ([[NSUserDefaults standardUserDefaults]boolForKey:kGroupByAlbumArtistKey]) {
            [fetchRequest setSortDescriptors:[NSArray arrayWithObjects:ratingSortDescriptor, titleSortDescriptor, albumByAlbumArtistSortDescriptor, albumByArtistSortDescriptor, artistByAlbumArtistSortDescriptor, artistByArtistSortDescriptor, trackSortDescriptor, creationDateSortDescriptor, nil]];
        }
        else {
            [fetchRequest setSortDescriptors:[NSArray arrayWithObjects:ratingSortDescriptor, titleSortDescriptor, albumByArtistSortDescriptor, albumByAlbumArtistSortDescriptor, artistByArtistSortDescriptor, artistByAlbumArtistSortDescriptor, trackSortDescriptor, creationDateSortDescriptor, nil]];
        }
        
        [fetchRequest setPredicate:[NSPredicate predicateWithFormat:@"rating > 3"]];
        
        NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc]initWithFetchRequest:fetchRequest managedObjectContext:managedObjectContext sectionNameKeyPath:nil cacheName:/* @"Top_Rated_Song_Cache" */ nil];
