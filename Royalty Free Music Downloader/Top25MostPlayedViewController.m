//
//  Top25MostPlayedViewController.m
...
@interface Top25MostPlayedViewController ()
...
@implementation Top25MostPlayedViewController
...
- (void)groupByAlbumArtistPreferenceDidChange {
    // [NSFetchedResultsController deleteCacheWithName:@"Top_25_Most_Played_Song_Cache"];
...
- (NSFetchedResultsController *)fetchedResultsController {
    if (!fetchedResultsController) {
        ...
        NSSortDescriptor *playCountSortDescriptor = [[NSSortDescriptor alloc]initWithKey:@"playCount" ascending:NO];
        ...
        if ([[NSUserDefaults standardUserDefaults]boolForKey:kGroupByAlbumArtistKey]) {
            [fetchRequest setSortDescriptors:[NSArray arrayWithObjects:playCountSortDescriptor, titleSortDescriptor, albumByAlbumArtistSortDescriptor, albumByArtistSortDescriptor, artistByAlbumArtistSortDescriptor, artistByArtistSortDescriptor, trackSortDescriptor, creationDateSortDescriptor, nil]];
        }
        else {
            [fetchRequest setSortDescriptors:[NSArray arrayWithObjects:playCountSortDescriptor, titleSortDescriptor, albumByArtistSortDescriptor, albumByAlbumArtistSortDescriptor, artistByArtistSortDescriptor, artistByAlbumArtistSortDescriptor, trackSortDescriptor, creationDateSortDescriptor, nil]];
        }
        
        [fetchRequest setPredicate:[NSPredicate predicateWithFormat:@"playCount > 0"]];
        
        NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc]initWithFetchRequest:fetchRequest managedObjectContext:managedObjectContext sectionNameKeyPath:nil cacheName:/* @"Top_25_Most_Played_Song_Cache" */ nil];
