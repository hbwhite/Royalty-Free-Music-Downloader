//
//  SimultaneousDownloadsViewController.m
...
@interface SimultaneousDownloadsViewController ()

@property (nonatomic) NSInteger selectedRow;

@end

@implementation SimultaneousDownloadsViewController
...
- (void)viewDidLoad {
    ...
    if ((simultaneousDownloads > 0) && (simultaneousDownloads <= 50)) {
        selectedRow = (simultaneousDownloads - 1);
    }
    else {
        selectedRow = 4;
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row != selectedRow) {
        ...
        [defaults setInteger:simultaneousDownloads forKey:kSimultaneousDownloadsKey];
        [defaults synchronize];
        
        [[[Downloader sharedDownloader]queue]setMaxConcurrentOperationCount:simultaneousDownloads];
