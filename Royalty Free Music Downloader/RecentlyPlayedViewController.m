...
- (void)groupByAlbumArtistPreferenceDidChange {
    // [NSFetchedResultsController deleteCacheWithName:@"Recently_Played_Song_Cache"];
...
- (NSFetchedResultsController *)fetchedResultsController {
    if (!fetchedResultsController) {
        ...
        NSSortDescriptor *lastPlayedDateSortDescriptor = [[NSSortDescriptor alloc]initWithKey:@"lastPlayedDate" ascending:NO];
        
        [fetchRequest setSortDescriptors:[NSArray arrayWithObjects:lastPlayedDateSortDescriptor, nil]];
        ...
        [fetchRequest setPredicate:[NSPredicate predicateWithFormat:@"lastPlayedDate >= %@", twoWeeksAgo]];
        
        NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc]initWithFetchRequest:fetchRequest managedObjectContext:managedObjectContext sectionNameKeyPath:nil cacheName:/* @"Recently_Played_Song_Cache" */ nil];
