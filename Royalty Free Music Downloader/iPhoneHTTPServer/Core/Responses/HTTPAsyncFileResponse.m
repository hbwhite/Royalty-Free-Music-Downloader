...
// This is required for Internet Explorer to recognize audio files instead of parsing them as plain text.
- (NSDictionary *)httpHeaders {
    ...
    return [NSDictionary dictionaryWithObjectsAndKeys:mimeTypeString, @"Content-Type", nil];
}
